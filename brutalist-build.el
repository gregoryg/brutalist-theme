...
(defun brutalist-build-custom-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-type-face ((t (:inherit fixed-pitch :foreground ,type-classes :underline nil :weight bold))))
   `(font-lock-variable-name-face ((t (:inherit fixed-pitch :foreground ,variables :underline nil))))
   `(font-lock-warning-face ((t (:inherit error))))
   `(fringe ((t (:background ,bg :foreground ,fg))))
   `(highlight ((t nil)))
   `(highlight-indentation-face ((t (:background ,highlight-indentation :foreground ,fg ))))
   `(lazy-highlight ((t (:background ,bg-highlight-3 ))))
   ;; `(hl-line ((t (:inverse-video t))))
   `(hl-line ((t (:background ,hl-line :foreground nil ))))
   ...
   `(mode-line ((t (:inherit fixed-pitch :background ,bg-light :foreground ,fg :height 1.0))))
   `(mode-line-buffer ((t (:foreground ,fg :weight bold))))
   `(mode-line-inactive ((t (:background ,bg-light :foreground ,fg :height 0.7))))
   ...
   `(org-drawer ((t (:inherit fixed-pitch :foreground ,fg-light :height 0.8))))
   `(org-block-begin-line ((t (:inherit fixed-pitch :foreground ,fg-block-begin-end :height 0.9))))
   `(org-block-end-line ((t (:inherit fixed-pitch :foreground ,fg-block-begin-end :height 0.9))))
   ...
   ;; `(ediff-even-diff-A  ((t (:foreground ,fg-ediff-unselected))))
   ;; `(ediff-even-diff-B  ((t (:foreground ,fg-ediff-unselected))))
   ;; `(ediff-odd-diff-A  ((t (:foreground ,fg-ediff-unselected))))
   ;; `(ediff-odd-diff-B  ((t (:foreground ,fg-ediff-unselected))))
